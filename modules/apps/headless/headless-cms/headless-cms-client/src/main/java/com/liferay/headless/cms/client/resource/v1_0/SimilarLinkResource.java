 ...
 */
@Generated("")
public interface SimilarLinkResource {
	...
	public HttpInvoker.HttpResponse getSimilarLinksPageHttpResponse(
			Long assetLibraryId, Pagination pagination)
		throws Exception;
	...
	public static class Builder {
		...
		public SimilarLinkResource build() {
			return new SimilarLinkResourceImpl(this);
		}
	...
	public static class SimilarLinkResourceImpl implements SimilarLinkResource {
		...
		public Page<SimilarLink> getSimilarLinksPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getSimilarLinksPageHttpResponse(assetLibraryId, pagination);
			...
			try {
				return Page.of(content, SimilarLinkSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-cms/v1.0/similar-links");
		...
		private SimilarLinkResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			SimilarLinkResource.class.getName());
...
// LIFERAY-REST-BUILDER-HASH:-1000816935