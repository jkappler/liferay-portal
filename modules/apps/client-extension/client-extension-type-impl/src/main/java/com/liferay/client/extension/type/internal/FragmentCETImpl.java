 ...
 * @author Pablo Molina
 */
public class FragmentCETImpl extends BaseCETImpl implements FragmentCET {

	public FragmentCETImpl(ClientExtensionEntry clientExtensionEntry) {
		super(clientExtensionEntry);
	}

	public FragmentCETImpl(PortletRequest portletRequest) {
		this(
			StringPool.BLANK,
			UnicodePropertiesBuilder.create(
				true
			).put(
				"css", ParamUtil.getString(portletRequest, "css")
			).put(
				"html", ParamUtil.getString(portletRequest, "html")
			).put(
				"js", ParamUtil.getString(portletRequest, "js")
			).build());
	}

	public FragmentCETImpl(
	...
	public String getEditJSP() {
		return "/admin/edit_fragment.jsp";
	}
	...
	public String getType() {
		return ClientExtensionEntryConstants.TYPE_FRAGMENT;
	}
	...
	private static final Set<String> _urlCETPropertyNames =
		getURLCETPropertyNames(FragmentCET.class);
