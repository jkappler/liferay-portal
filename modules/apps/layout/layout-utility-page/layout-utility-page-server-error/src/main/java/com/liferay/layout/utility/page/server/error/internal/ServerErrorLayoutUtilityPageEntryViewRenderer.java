...
package com.liferay.layout.utility.page.server.error.internal;
...
public class ServerErrorLayoutUtilityPageEntryViewRenderer
	...
	public void renderHTML(
		...
		RequestDispatcher requestDispatcher =
			_servletContext.getRequestDispatcher("/server_error.jsp");
	...
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.layout.utility.page.server.error)"
	)
