...
public class CommonStatusLayoutUtilityPageEntryRequestContributorTest {
	...
	private VirtualHost _getMockVirtualHostWithLayouts(
			Long groupId, Layout firstPrivateLayout, Layout firstPublicLayout)
		throws PortalException {
		...
		_mockLayoutLocalService(
			mockGroup, firstPublicLayout, firstPrivateLayout);
	...
	private void _mockLayoutLocalService(
		Group group, Layout firstPrivateLayout, Layout firstPublicLayout) {
