...
create unique index IX_38FC705C on LayoutPageTemplateSetting (groupId, classNameId, classPK);
create index IX_233D19F7 on LayoutPageTemplateSetting (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_6E61B239 on LayoutPageTemplateSetting (uuid_[$COLUMN_LENGTH:75$], groupId);