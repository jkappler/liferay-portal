...
@Component(
	immediate = true,
	property = "layout.type=" + CollectionLayoutTypeControllerConstants.LAYOUT_TYPE_COLLECTION,
	service = LayoutTypeController.class
)
public class CollectionLayoutTypeController
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CollectionLayoutTypeController.class);
