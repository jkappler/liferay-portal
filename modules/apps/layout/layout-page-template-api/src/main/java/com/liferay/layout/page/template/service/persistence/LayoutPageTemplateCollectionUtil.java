...
public class LayoutPageTemplateCollectionUtil {
	...
	public static List<LayoutPageTemplateCollection>
		...
		return getPersistence().findByParentLayoutPageTemplateCollectionId(
	...
	public static LayoutPageTemplateCollection
		...
		return getPersistence().findByParentLayoutPageTemplateCollectionId_Last(
			parentLayoutPageTemplateCollectionId, orderByComparator);
	}
	 ...
	 * @param parentLayoutPageTemplateCollectionId the parent layout page template collection ID
	 */
	public static void removeByParentLayoutPageTemplateCollectionId(
		long parentLayoutPageTemplateCollectionId) {

		getPersistence().removeByParentLayoutPageTemplateCollectionId(
			parentLayoutPageTemplateCollectionId);
	}
	 ...
	 * @return the number of matching layout page template collections
	 */
	public static int countByParentLayoutPageTemplateCollectionId(
		long parentLayoutPageTemplateCollectionId) {

		return getPersistence().countByParentLayoutPageTemplateCollectionId(
			parentLayoutPageTemplateCollectionId);
	}
