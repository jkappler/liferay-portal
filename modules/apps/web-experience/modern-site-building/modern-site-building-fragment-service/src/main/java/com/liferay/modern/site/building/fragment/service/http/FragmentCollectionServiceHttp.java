...
public class FragmentCollectionServiceHttp {
	...
	public static int getGroupFragmentCollectionsCount(
		...
		try {
			MethodKey methodKey = new MethodKey(FragmentCollectionServiceUtil.class,
					...
					_getGroupFragmentCollectionsCountParameterTypes6);
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.modern.site.building.fragment.model.FragmentCollection> searchFragmentCollections(
		HttpPrincipal httpPrincipal, long groupId, java.lang.String title,
		int start, int end, com.liferay.portal.kernel.search.Sort sort)
		throws com.liferay.portal.kernel.exception.PortalException {
		try {
			MethodKey methodKey = new MethodKey(FragmentCollectionServiceUtil.class,
					"searchFragmentCollections",
					_searchFragmentCollectionsParameterTypes7);

			MethodHandler methodHandler = new MethodHandler(methodKey, groupId,
					title, start, end, sort);
			...
			return (com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.modern.site.building.fragment.model.FragmentCollection>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _getGroupFragmentCollectionsCountParameterTypes6 =
		new Class[] { long.class };
	private static final Class<?>[] _searchFragmentCollectionsParameterTypes7 = new Class[] {
