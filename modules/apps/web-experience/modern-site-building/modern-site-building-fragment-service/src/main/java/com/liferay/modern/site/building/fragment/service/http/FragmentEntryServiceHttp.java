...
public class FragmentEntryServiceHttp {
	...
	public static com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.modern.site.building.fragment.model.FragmentEntry> searchFragmentEntries(
		HttpPrincipal httpPrincipal, long groupId, long fragmentCollectionId,
		...
		try {
			MethodKey methodKey = new MethodKey(FragmentEntryServiceUtil.class,
					"searchFragmentEntries",
					_searchFragmentEntriesParameterTypes8);

			MethodHandler methodHandler = new MethodHandler(methodKey, groupId,
					fragmentCollectionId, title, start, end, sort);
			...
			return (com.liferay.portal.kernel.search.BaseModelSearchResult<com.liferay.modern.site.building.fragment.model.FragmentEntry>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _searchFragmentEntriesParameterTypes8 = new Class[] {
