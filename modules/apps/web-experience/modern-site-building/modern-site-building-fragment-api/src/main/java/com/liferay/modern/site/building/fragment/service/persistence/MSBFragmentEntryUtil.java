...
public class MSBFragmentEntryUtil {
	...
	*/
	public static List<MSBFragmentEntry> findByG_FC(long groupId,
		long msbFragmentCollectionId) {
		return getPersistence().findByG_FC(groupId, msbFragmentCollectionId);
	}
	...
	*/
	public static List<MSBFragmentEntry> findByG_FC(long groupId,
		long msbFragmentCollectionId, int start, int end) {
		return getPersistence()
				   .findByG_FC(groupId, msbFragmentCollectionId, start, end);
	}
	...
	*/
	public static MSBFragmentEntry findByG_FC_First(long groupId,
		...
		throws com.liferay.modern.site.building.fragment.exception.NoSuchMSBFragmentEntryException {
		return getPersistence()
				   .findByG_FC_First(groupId, msbFragmentCollectionId,
			orderByComparator);
	}
	...
	*/
	public static MSBFragmentEntry fetchByG_FC_First(long groupId,
		...
		OrderByComparator<MSBFragmentEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_FC_First(groupId, msbFragmentCollectionId,
			orderByComparator);
	}
	...
	*/
	public static MSBFragmentEntry findByG_FC_Last(long groupId,
		...
		throws com.liferay.modern.site.building.fragment.exception.NoSuchMSBFragmentEntryException {
		return getPersistence()
				   .findByG_FC_Last(groupId, msbFragmentCollectionId,
			orderByComparator);
	}
	...
	*/
	public static MSBFragmentEntry fetchByG_FC_Last(long groupId,
		...
		OrderByComparator<MSBFragmentEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_FC_Last(groupId, msbFragmentCollectionId,
			orderByComparator);
	}
	...
	*/
	public static List<MSBFragmentEntry> filterFindByG_FC(long groupId,
		long msbFragmentCollectionId) {
		return getPersistence()
				   .filterFindByG_FC(groupId, msbFragmentCollectionId);
	}
	...
	*/
	public static List<MSBFragmentEntry> filterFindByG_FC(long groupId,
		long msbFragmentCollectionId, int start, int end) {
		return getPersistence()
				   .filterFindByG_FC(groupId, msbFragmentCollectionId, start,
			end);
	}
	...
	* @param msbFragmentCollectionId the msb fragment collection ID
	*/
	public static void removeByG_FC(long groupId, long msbFragmentCollectionId) {
		getPersistence().removeByG_FC(groupId, msbFragmentCollectionId);
	}
	...
	* @return the number of matching msb fragment entries
	*/
	public static int countByG_FC(long groupId, long msbFragmentCollectionId) {
		return getPersistence().countByG_FC(groupId, msbFragmentCollectionId);
	}
	...
	* @return the number of matching msb fragment entries that the user has permission to view
	*/
	public static int filterCountByG_FC(long groupId,
		long msbFragmentCollectionId) {
		return getPersistence()
				   .filterCountByG_FC(groupId, msbFragmentCollectionId);
	}
	...
	*/
	public static List<MSBFragmentEntry> findByG_LikeN_FC(long groupId,
		java.lang.String name, long msbFragmentCollectionId) {
		return getPersistence()
				   .findByG_LikeN_FC(groupId, name, msbFragmentCollectionId);
	}
	...
	*/
	public static List<MSBFragmentEntry> findByG_LikeN_FC(long groupId,
		java.lang.String name, long msbFragmentCollectionId, int start, int end) {
		return getPersistence()
				   .findByG_LikeN_FC(groupId, name, msbFragmentCollectionId,
			start, end);
	}
	...
	*/
	public static List<MSBFragmentEntry> findByG_LikeN_FC(long groupId,
		java.lang.String name, long msbFragmentCollectionId, int start,
		int end, OrderByComparator<MSBFragmentEntry> orderByComparator) {
		return getPersistence()
				   .findByG_LikeN_FC(groupId, name, msbFragmentCollectionId,
			start, end, orderByComparator);
	...
	*/
	public static MSBFragmentEntry findByG_LikeN_FC_First(long groupId,
		...
		throws com.liferay.modern.site.building.fragment.exception.NoSuchMSBFragmentEntryException {
		return getPersistence()
				   .findByG_LikeN_FC_First(groupId, name,
			msbFragmentCollectionId, orderByComparator);
	}
	...
	*/
	public static MSBFragmentEntry findByG_LikeN_FC_Last(long groupId,
		...
		throws com.liferay.modern.site.building.fragment.exception.NoSuchMSBFragmentEntryException {
		return getPersistence()
				   .findByG_LikeN_FC_Last(groupId, name,
			msbFragmentCollectionId, orderByComparator);
	}
	...
	*/
	public static MSBFragmentEntry fetchByG_LikeN_FC_Last(long groupId,
		...
		OrderByComparator<MSBFragmentEntry> orderByComparator) {
		return getPersistence()
				   .fetchByG_LikeN_FC_Last(groupId, name,
			msbFragmentCollectionId, orderByComparator);
	}
	...
	*/
	public static List<MSBFragmentEntry> filterFindByG_LikeN_FC(long groupId,
		java.lang.String name, long msbFragmentCollectionId) {
		return getPersistence()
				   .filterFindByG_LikeN_FC(groupId, name,
	...
	*/
	public static void removeByG_LikeN_FC(long groupId, java.lang.String name,
		long msbFragmentCollectionId) {
		getPersistence()
			.removeByG_LikeN_FC(groupId, name, msbFragmentCollectionId);
	}
	...
	*/
	public static int countByG_LikeN_FC(long groupId, java.lang.String name,
		long msbFragmentCollectionId) {
		return getPersistence()
				   .countByG_LikeN_FC(groupId, name, msbFragmentCollectionId);
	}
	...
	*/
	public static int filterCountByG_LikeN_FC(long groupId,
		java.lang.String name, long msbFragmentCollectionId) {
		return getPersistence()
				   .filterCountByG_LikeN_FC(groupId, name,
			msbFragmentCollectionId);
	}
