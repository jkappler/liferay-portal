...
public class FragmentEntryWrapper implements FragmentEntry,
	...
	/**
	* Returns <code>true</code> if this fragment entry is in the Recycle Bin.
	*
	* @return <code>true</code> if this fragment entry is in the Recycle Bin; <code>false</code> otherwise
	*/
	@Override
	public boolean isInTrash() {
		return _fragmentEntry.isInTrash();
	}

	/**
	* Returns <code>true</code> if the parent of this fragment entry is in the Recycle Bin.
	*
	* @return <code>true</code> if the parent of this fragment entry is in the Recycle Bin; <code>false</code> otherwise
	*/
	@Override
	public boolean isInTrashContainer() {
		return _fragmentEntry.isInTrashContainer();
	}

	@Override
	public boolean isInTrashExplicitly() {
		return _fragmentEntry.isInTrashExplicitly();
	}

	@Override
	public boolean isInTrashImplicitly() {
		return _fragmentEntry.isInTrashImplicitly();
	}
	...
	/**
	* Returns the trash handler for this fragment entry.
	*
	* @return the trash handler for this fragment entry
	* @deprecated As of 7.0.0, with no direct replacement
	*/
	@Deprecated
	@Override
	public com.liferay.portal.kernel.trash.TrashHandler getTrashHandler() {
		return _fragmentEntry.getTrashHandler();
	}

	/**
	* Returns the trash entry created when this fragment entry was moved to the Recycle Bin. The trash entry may belong to one of the ancestors of this fragment entry.
	*
	* @return the trash entry created when this fragment entry was moved to the Recycle Bin
	*/
	@Override
	public com.liferay.trash.kernel.model.TrashEntry getTrashEntry()
		throws com.liferay.portal.kernel.exception.PortalException {
		return _fragmentEntry.getTrashEntry();
	}
	...
	*/
	...
	/**
	* Returns the class primary key of the trash entry for this fragment entry.
	*
	* @return the class primary key of the trash entry for this fragment entry
	*/
	@Override
	public long getTrashEntryClassPK() {
		return _fragmentEntry.getTrashEntryClassPK();
	}
