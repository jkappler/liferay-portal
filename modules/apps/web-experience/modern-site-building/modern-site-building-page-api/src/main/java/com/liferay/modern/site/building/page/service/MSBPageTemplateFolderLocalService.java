...
/**
 * Provides the local service interface for MSBPageTemplateFolder. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MSBPageTemplateFolderLocalServiceUtil
...
public interface MSBPageTemplateFolderLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MSBPageTemplateFolderLocalServiceUtil} to access the msb page template folder local service. Add custom service methods to {@link com.liferay.modern.site.building.page.service.impl.MSBPageTemplateFolderLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public MSBPageTemplateFolder createMSBPageTemplateFolder(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MSBPageTemplateFolder fetchMSBPageTemplateFolderByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MSBPageTemplateFolder getMSBPageTemplateFolderByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MSBPageTemplateFolder> getMSBPageTemplateFolders(int start,
		int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MSBPageTemplateFolder> getMSBPageTemplateFoldersByUuidAndCompanyId(
