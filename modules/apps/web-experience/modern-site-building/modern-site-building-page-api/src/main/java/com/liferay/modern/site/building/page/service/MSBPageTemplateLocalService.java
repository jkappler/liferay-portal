...
/**
 * Provides the local service interface for MSBPageTemplate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MSBPageTemplateLocalServiceUtil
...
public interface MSBPageTemplateLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MSBPageTemplateLocalServiceUtil} to access the msb page template local service. Add custom service methods to {@link com.liferay.modern.site.building.page.service.impl.MSBPageTemplateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MSBPageTemplate addMSBPageTemplate(MSBPageTemplate msbPageTemplate);
	...
	*/
	public MSBPageTemplate createMSBPageTemplate(long msbPageTemplateId);
	...
	*/
	...
	public MSBPageTemplate deleteMSBPageTemplate(long msbPageTemplateId)
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MSBPageTemplate deleteMSBPageTemplate(
	...
	*/
	...
	public MSBPageTemplate fetchMSBPageTemplate(long msbPageTemplateId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MSBPageTemplate fetchMSBPageTemplateByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MSBPageTemplate getMSBPageTemplate(long msbPageTemplateId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MSBPageTemplate getMSBPageTemplateByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MSBPageTemplate> getMSBPageTemplates(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MSBPageTemplate> getMSBPageTemplatesByUuidAndCompanyId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MSBPageTemplate updateMSBPageTemplate(
		MSBPageTemplate msbPageTemplate);
}