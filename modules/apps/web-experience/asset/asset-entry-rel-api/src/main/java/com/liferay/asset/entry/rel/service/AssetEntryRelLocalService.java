...
/**
 * Provides the local service interface for AssetEntryRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AssetEntryRelLocalServiceUtil
...
public interface AssetEntryRelLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssetEntryRelLocalServiceUtil} to access the asset entry rel local service. Add custom service methods to {@link com.liferay.asset.entry.rel.service.impl.AssetEntryRelLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
