	...
	<liferay-frontend:management-bar-buttons>
		...
		<liferay-frontend:management-bar-filters>
			...
			>
				...
				viewCategoryHomeURL.setParameter("navigation", AssetCategoriesNavigationFilterKeys.ALL);
				%>
...
<aui:script sandbox="<%= true %>" use="liferay-item-selector-dialog">
	...
	viewCategoryFilteredURL.setParameter("navigation", AssetCategoriesNavigationFilterKeys.CATEGORY);
