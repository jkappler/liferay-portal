...
public class FragmentEntryServiceHttp {
	...
	public static java.util.List<com.liferay.fragment.model.LayoutFragment> getLayoutFragments(
		...
		try {
			MethodKey methodKey = new MethodKey(FragmentEntryServiceUtil.class,
					"getLayoutFragments", _getLayoutFragmentsParameterTypes12);
			...
			return (java.util.List<com.liferay.fragment.model.LayoutFragment>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	private static final Class<?>[] _getLayoutFragmentsParameterTypes12 = new Class[] {
			long.class, long.class
		};
