...
import com.liferay.fragment.model.impl.LayoutFragmentImpl;
import com.liferay.fragment.model.impl.LayoutFragmentModelImpl;
 ...
 * @see com.liferay.fragment.service.persistence.LayoutFragmentUtil
 * @generated
 */
@ProviderType
public class LayoutFragmentPersistenceImpl extends BasePersistenceImpl<LayoutFragment>
	 ...
	 * @throws NoSuchLayoutFragmentException if a matching layout fragment could not be found
	 */
	@Override
	public LayoutFragment findByGroupId_First(long groupId,
		OrderByComparator<LayoutFragment> orderByComparator)
		throws NoSuchLayoutFragmentException {
		...
		throw new NoSuchLayoutFragmentException(msg.toString());
	}
	 ...
	 * @throws NoSuchLayoutFragmentException if a layout fragment with the primary key could not be found
	 */
	@Override
	...
	public LayoutFragment remove(Serializable primaryKey)
		...
		try {
			...
			if (layoutFragment == null) {
				...
				throw new NoSuchLayoutFragmentException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}

			return remove(layoutFragment);
		}
		catch (NoSuchLayoutFragmentException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	protected LayoutFragment toUnwrappedModel(LayoutFragment layoutFragment) {
		...
		layoutFragmentImpl.setEditableValues(layoutFragment.getEditableValues());
	...
	/**
	 * Returns the layout fragment with the primary key or throws a {@link NoSuchLayoutFragmentException} if it could not be found.
	 *
	 * @param layoutFragmentId the primary key of the layout fragment
	 * @return the layout fragment
	 * @throws NoSuchLayoutFragmentException if a layout fragment with the primary key could not be found
