...
public interface LayoutFragmentLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LayoutFragmentLocalServiceUtil} to access the layout fragment local service. Add custom service methods to {@link com.liferay.fragment.service.impl.LayoutFragmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public LayoutFragment addLayoutFragment(long groupId, long plid,
		...
		java.lang.String js, int position) throws PortalException;

	public void addLayoutFragments(long groupId, long plid,
		List<FragmentEntry> fragmentEntries) throws PortalException;
