...
package com.liferay.layout.service.service.base;

import aQute.bnd.annotation.ProviderType;

import com.liferay.layout.service.model.LayoutFragment;
import com.liferay.layout.service.service.LayoutFragmentLocalService;
...
/**
 * Provides the base implementation for the layout fragment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.layout.service.service.impl.LayoutFragmentLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class LayoutFragmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements LayoutFragmentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.layout.service.service.LayoutFragmentLocalServiceUtil} to access the layout fragment local service.
	 */
	...
	public LayoutFragment addLayoutFragment(LayoutFragment layoutFragment) {
		...
		return layoutFragmentPersistence.update(layoutFragment);
	}
	...
	public LayoutFragment createLayoutFragment(long layoutFragmentId) {
		return layoutFragmentPersistence.create(layoutFragmentId);
	}
	...
	public LayoutFragment deleteLayoutFragment(long layoutFragmentId)
		...
		return layoutFragmentPersistence.remove(layoutFragmentId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(LayoutFragment.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return layoutFragmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return layoutFragmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public LayoutFragment fetchLayoutFragment(long layoutFragmentId) {
		return layoutFragmentPersistence.fetchByPrimaryKey(layoutFragmentId);
	}
	...
	public LayoutFragment getLayoutFragment(long layoutFragmentId)
		throws PortalException {
		return layoutFragmentPersistence.findByPrimaryKey(layoutFragmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(layoutFragmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LayoutFragment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("layoutFragmentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(layoutFragmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LayoutFragment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return layoutFragmentLocalService.deleteLayoutFragment((LayoutFragment)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return layoutFragmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LayoutFragment> getLayoutFragments(int start, int end) {
		return layoutFragmentPersistence.findAll(start, end);
	}
	...
	public int getLayoutFragmentsCount() {
		return layoutFragmentPersistence.countAll();
	}
	 ...
	 */
	public LayoutFragmentLocalService getLayoutFragmentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.layout.service.model.LayoutFragment",
			layoutFragmentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.layout.service.model.LayoutFragment");
	}
	...
	public String getOSGiServiceIdentifier() {
		return LayoutFragmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = layoutFragmentPersistence.getDataSource();
	...
	@BeanReference(type = LayoutFragmentLocalService.class)
	protected LayoutFragmentLocalService layoutFragmentLocalService;
