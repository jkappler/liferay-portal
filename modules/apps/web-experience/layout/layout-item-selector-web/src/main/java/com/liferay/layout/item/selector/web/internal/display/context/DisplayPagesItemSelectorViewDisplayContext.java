 ...
 */
public class DisplayPagesItemSelectorViewDisplayContext {

	public DisplayPagesItemSelectorViewDisplayContext(
		...
		_displayPageSelectorCriterion = displayPageSelectorCriterion;
	...
	public SearchContainer getDisplayPagesSearchContainer()
		...
		List<LayoutPageTemplateEntry> layoutPageTemplateEntries =
			LayoutPageTemplateEntryServiceUtil.getLayoutPageTemplateEntries(
				...
				_displayPageSelectorCriterion.getClassNameId(),
				_displayPageSelectorCriterion.getClassTypeId(),
		...
		return displayPagesSearchContainer;
	}
	...
	public String getDisplayStyle() {
		...
		_displayStyle = portalPreferences.getValue(
			LayoutsItemSelectorWebKeys.LAYOUT_ITEM_SELECTOR, "display-style",
			"icon");
	...
	private final DisplayPageSelectorCriterion _displayPageSelectorCriterion;
