...
public class LayoutPageTemplateDisplayContext {
	...
	public JSONArray getFragmentCollections() throws PortalException {
		...
		JSONArray jsonFragmentCollections = JSONFactoryUtil.createJSONArray();
		...
		for (FragmentCollection fragmentCollection : fragmentCollections) {
			...
			if (ListUtil.isNotEmpty(fragmentEntries)) {
				JSONObject jsonFragmentCollection =
					JSONFactoryUtil.createJSONObject();

				jsonFragmentCollection.put(
					"id", fragmentCollection.getFragmentCollectionId());
				jsonFragmentCollection.put(
					"name", fragmentCollection.getName());

				JSONArray jsonFragmentEntries =
				...
				for (FragmentEntry fragmentEntry : fragmentEntries) {
					...
					jsonFragmentEntries.put(jsonFragmentEntry);
				}

				jsonFragmentCollection.put("entries", jsonFragmentEntries);

				jsonFragmentCollections.put(jsonFragmentCollection);
			}
		}

		return jsonFragmentCollections;
	}
	...
	public JSONArray getLayoutPageTemplateFragments() throws PortalException {
		...
		JSONArray jsonLayoutPageTemplateFragments =
			JSONFactoryUtil.createJSONArray();
		...
		for (LayoutPageTemplateFragment layoutPageTemplateFragment :
			...
			JSONObject jsonFragmentEntry = JSONFactoryUtil.createJSONObject();

			jsonFragmentEntry.put(
				"fragmentEntryId", fragmentEntry.getFragmentEntryId());
			jsonFragmentEntry.put("name", fragmentEntry.getName());

			jsonLayoutPageTemplateFragments.put(jsonFragmentEntry);
		}

		return jsonLayoutPageTemplateFragments;
	}
