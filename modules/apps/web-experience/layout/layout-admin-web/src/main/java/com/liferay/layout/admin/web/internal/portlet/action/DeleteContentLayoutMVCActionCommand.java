...
@Component(
	...
	property = {
		...
		"mvc.command.name=/layout/delete_content_layout"
	},
	service = MVCActionCommand.class
)
public class DeleteContentLayoutMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		_layoutFragmentService.deleteContentLayout(
			themeDisplay.getScopeGroupId(), selPlid, serviceContext);
	}
