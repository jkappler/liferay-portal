...
public class DLCustomExtensionFileItemSelectorView
	extends BaseDLItemSelectorView<FileCustomExtensionItemSelectorCriterion> {

	@Override
	public Class<FileCustomExtensionItemSelectorCriterion>
		getItemSelectorCriterionClass() {

		return FileCustomExtensionItemSelectorCriterion.class;
	}
