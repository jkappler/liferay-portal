...
public class InfoRequestFieldValuesProviderHelper {
	...
	public List<InfoFieldValue<Object>> getInfoFieldValues(
		...
		for (InfoField<?> infoField : _getInfoFields(
			className, formVariationKey, themeDisplay.getScopeGroupId())) {
	...
	private InfoFieldValue<Object> _getBooleanInfoFieldValue(
		...
		return _getInfoFieldValue(
			infoField, locale, Boolean.parseBoolean(value));
	}
	...
	private <T> List<InfoField> _getInfoFields(
		...
		try {
			...
			if (_log.isDebugEnabled()) {
				_log.debug(
					noSuchFormVariationException, noSuchFormVariationException);
			}
