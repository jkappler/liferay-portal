...
public interface VideoEmbedderConfiguration {
	...
	@Meta.AD(
		deflt=
			...
			description="iframeurl-descriptions",
	...
	public static final String BILIBILI_I_P = "static.hdslb.com/miniloader.swf?aid=";
	...
	public static final String QQ_V_P = "^.*?cover/[a-zA-Z0-9]+/([a-zA-Z0-9]+).*$";
	public static final String QQ_V_P_2 = "^.*?page/([a-zA-Z0-9]+).*$";
	public static final String QQ = "qq";
	public static final String ACFUN_I_P = "cdn.aixifan.com/player/ACFlashPlayer.out.swf?vid=";
	public static final String ACFUN_V_P = "^.*?ac([0-9]+).*$";
	public static final String ACFUN = "acfun";
	public static final String SOHU_I_P = "tv.sohu.com/upload/public static/share/share_play.html#";
