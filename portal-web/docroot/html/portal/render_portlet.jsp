...
if (urlConfiguration != null) {
	if (configurationAction != null) {
		portletDisplay.setUrlConfigurationViewInContextWindowState(configurationAction.getWindowsState());
	...
	portletDisplay.setURLConfigurationViewInContext(urlConfiguration.toString());
